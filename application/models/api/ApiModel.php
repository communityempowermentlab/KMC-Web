        ...
        if ($countData > 0)
        {
            ...
            foreach ($request['stuckData'] as $key => $val)
            {
                ...
                if(!empty($val['loungeId'])){
                    ...
                    if ($loungeName['status'] == '1') {
                        $alertSms1 = "You will soon receive a call for your support.";
                        sendMobileMessage($loungeName['loungeContactNumber'], $alertSms1);
                    }
                } else {
                ...
                if(($settingData['newEnquiryNotification'] == "1") && (!empty($settingData['newEnquiryNotificationMobiles']))){
                    $explodeMobile = explode(",",$settingData['newEnquiryNotificationMobiles']);
                        // $alertSms1 = "You will soon recieve a call for your support";
                        // sendMobileMessage("9455209160", $alertSms1);
