  ...
  public function BabyWeightPdfFile($LoungeID, $BabyID,$id)
  {
        ...
        $html.= '
                ...
                <table style="margin-top:10px;border:1px solid;width: 100% " >
                    ...
                    <td style="width: 11%;text-align: center;border:1px solid ; padding: 8px"><b>Signature<br>of nurse<br>taking<br>weight</b></td>
                  </tr>';
                  $i =1;
        ...
        $pdfFilePath =  pdfDirectory."b_".$getBabyFileId['id']."_weight.pdf";
        ...
        return "b_".$getBabyFileId['id']."_weight.pdf";
    }
