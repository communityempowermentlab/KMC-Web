...
// total baby discharge
  ...
  // total baby admition and baby & mother discharge  by lounge
  public function totaladmitionDischargeBylounge($loungeArray){
    $loungeId = implode(",", $loungeArray);
    $qry = "SELECT * FROM `V_totalAdmissionDischargein7days` where loungeid in (".$loungeId.")  
ORDER BY `V_totalAdmissionDischargein7days`.`loungeId` ASC";
  ...
  //   $loungeId = implode(",", $loungeArray);
  //   $qry = "SELECT
  // `l`.`loungeId` AS `loungeId`,
  // `l`.`loungeName` AS `loungeName`,
  // TIMESTAMP(CURDATE(),
  // '08:00:00') AS `LASTdate`,
  // COUNT(DISTINCT `a`.`admissionDateTime`) AS `babyAdmit`,
  // COUNT(
  //   DISTINCT IF(
  //     TIMESTAMPDIFF(
  //       SECOND,
  ...
  //         `a`.`admissionDateTime`,
  //         TIMESTAMP(CURDATE(),
  //         '08:00:00')) BETWEEN 86400 AND 86400 * 2,
  //         `a`.`admissionDateTime`,
  //         NULL
  //       )
  //     ) AS Day2Admition,
  ...
  //           `a`.`admissionDateTime`,
  //           TIMESTAMP(CURDATE(),
  //           '08:00:00')) BETWEEN 86400 * 2 AND 86400 * 3,
  //           `a`.`admissionDateTime`,
  //           NULL
  //         )
  //       ) AS Day3Admition,
  ...
  //             `a`.`admissionDateTime`,
  //             TIMESTAMP(CURDATE(),
  //             '08:00:00')) BETWEEN 86400 * 3 AND 86400 * 4,
  //             `a`.`admissionDateTime`,
  //             NULL
  //           )
  //         ) AS Day4Admition,
  ...
  //               `a`.`admissionDateTime`,
  //               TIMESTAMP(CURDATE(),
  //               '08:00:00')) BETWEEN 86400 * 4 AND 86400 * 5,
  //               `a`.`admissionDateTime`,
  //               NULL
  //             )
  //           ) AS Day5Admition,
  ...
  //                 `a`.`admissionDateTime`,
  //                 TIMESTAMP(CURDATE(),
  //                 '08:00:00')) BETWEEN 86400 * 5 AND 86400 * 6,
  //                 `a`.`admissionDateTime`,
  //                 NULL
  //               )
  //             ) AS Day6Admition,
  ...
  //                   `a`.`admissionDateTime`,
  //                   TIMESTAMP(CURDATE(),
  //                   '08:00:00')) BETWEEN 86400 * 6 AND 86400 * 7,
  //                   `a`.`admissionDateTime`,
  //                   NULL
  //                 )
  //               ) AS Day7Admition,
  //               COUNT(DISTINCT `b`.`dateOfDischarge`) AS `babydischarge`,
  //               COUNT(
  //                 DISTINCT IF(
  //                   TIMESTAMPDIFF(
  //                     SECOND,
  ...
  //                                 NULL
  //                               )
  //                             ) AS Day7Babydischarge,
  //                             COUNT(DISTINCT `c`.`dateOfDischarge`) AS `motherdischarge`,
  //                             COUNT(
  //                               DISTINCT IF(
  //                                 TIMESTAMPDIFF(
  //                                   SECOND,
  ...
  //                                                   (
  //                                                     (
  //                                                       (`kmcV2`.`loungeMaster` `l`)
  //                                                     LEFT JOIN
  //                                                       `kmcV2`.`babyAdmission` `a` ON(
  //                                                         (
  //                                                           (`l`.`status` = 1) AND(`l`.`loungeId` = `a`.`loungeId`) AND(
  //                                                             TIMESTAMPDIFF(
  //                                                               SECOND,
  //                                                               `a`.`admissionDateTime`,
  //                                                               TIMESTAMP(CURDATE(),
  //                                                               '08:00:00')) BETWEEN 0 AND 86400 * 7
  //                                                             )
  //                                                           )
  //                                                         )
  //                                                       )
  //                                                     LEFT JOIN
  //                                                       `kmcV2`.`babyRegistration` `d` ON((`a`.`babyId` = `d`.`babyId`))
  //                                                     )
  //                                                   LEFT JOIN
  //                                                     `kmcV2`.`motherRegistration` `e` ON((`d`.`motherId` = `e`.`motherId`))
  //                                                   )
  //                                                 LEFT JOIN
  //                                                   `kmcV2`.`motherAdmission` `g` ON((`d`.`motherId` = `g`.`motherId`))
  //                                                 )
  //                                               LEFT JOIN
  //                                                 `kmcV2`.`babyAdmission` `b` ON(
  //                                                   (
  //                                                     (`l`.`loungeId` = `b`.`loungeId`) AND(
  //                                                       TIMESTAMPDIFF(
  //                                                         SECOND,
  //                                                         `b`.`dateOfDischarge`,
  //                                                         TIMESTAMP(CURDATE(),
  ...
  //                                                 )
  //                                               LEFT JOIN
  //                                                 `kmcV2`.`motherAdmission` `c` ON(
  //                                                   (
  //                                                     (`l`.`loungeId` = `c`.`loungeId`) AND(
  //                                                       TIMESTAMPDIFF(
  //                                                         SECOND,
  //                                                         `c`.`dateOfDischarge`,
  //                                                         TIMESTAMP(CURDATE(),
