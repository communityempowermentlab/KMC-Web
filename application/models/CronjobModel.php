...
ORDER BY `V_totalAdmissionDischargein7days`.`loungeId` ASC";
  ...
  public function exceptionReportFor1Day($loungeArray){
    $loungeId = implode(",", $loungeArray);
    $qry = "SELECT * FROM `V_totalAdmissionDischargein7days` where loungeid in (".$loungeId.") AND (day1Admission='0' OR day1BabyDischarge='0' OR day1MotherDischarge='0')
ORDER BY `V_totalAdmissionDischargein7days`.`loungeId` ASC";
  ...
  public function exceptionReportFor7Day($loungeArray){
    $loungeId = implode(",", $loungeArray);
    $qry = "SELECT * FROM `V_totalAdmissionDischargein7days` where loungeid in (".$loungeId.") AND (babyAdmit='0' OR babyDischarge='0' OR motherDischarge='0')
      ORDER BY `V_totalAdmissionDischargein7days`.`loungeId` ASC";
