...
<div class="wrapper">
  	...
  	<header class="main-header" style="position: fixed;top:0;right:0;width: 100%;">
	    ...
	    <a href="<?php echo base_url('/admin/Dashboard/index'); ?>" class="logo">
	      <!-- mini logo for sidebar mini 50x50 pixels -->
	      	...
	      	<span class="logo-lg"> <b>The Kangaroo </b>Care</span>
	    </a>
      ...
      $GetAdminInfo=$this->load->facility_model->GetAdminInfo();
       $count  = $this->load->facility_model->CountNotification($GetAdminInfo['NotificationTime']);
       $coun1  = $this->load->facility_model->CountSMS($GetAdminInfo['SmsTime']);
       $Notification  = $this->load->facility_model->GetlatestNotification();
       $SMS  = $this->load->facility_model->GetlatestSms(); 
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  foreach ($SMS as $key => $value) {
                    $GetFacilittyName = $this->facility_model->GetFacilityName($value['FacilityID']);
                    $BabyDetail = $this->facility_model->getBabysBYID($value['BabyID']);
                  ?>
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
