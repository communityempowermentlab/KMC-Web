<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
  ...
  <?php $adminData = $this->session->userdata('adminData');  ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
         ...
         <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo $this->user_model->TotalSchool() ?></h3>
            ...
            <div class="icon">
             ...
             <a <a href="<?php echo site_url('admin/School/listing');?>" class="small-box-footer">View Schools <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
    ...
    <?php if($adminData['Type'] == 3){ ?>
          ...
          <section class="content">
            <div class="row">
     <?php  $GetAllBranch =  $this->user_model->GetSchoolALlBranch($adminData['Id']) ;
        //print_r($GetAllBranch);
        foreach ($GetAllBranch as  $value) {?>
            <!-- Small boxes (Stat box) -->
              <div class="col-lg-3 col-xs-6">
                <!-- small box -->
                <div class="small-box bg-aqua">
                  <div class="inner">
                    <p style="font-size: 18px"><?php echo $value['school_address']."<br/>Pin-code :-".$value['pincode']?></p>
                  </div>
                  <div class="icon">
                    <i class="ion ion-university"></i>
                  </div>
                    <a href="<?php echo site_url('admin/School/AddClassSection')."/".$value['id'];?>" class="small-box-footer">View Class 
