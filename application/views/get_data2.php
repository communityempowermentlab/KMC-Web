     ...
     // $TotalKMC = $this->load->FacilityModel->overAllLoungeKMC($_REQUEST['loungeWiseValue']);    
      ...
      // bottom graph code
          ...
          /*                $lastesMonthKmc  = floor(($lastesMonthKmc['totalseconds']/60)/60);
                        ...
                        $minutes5 = floor(($lastesMonthKm4['totalseconds'] / 60) % 60);
                            ...
                            $this->db->order_by('id','desc'); 
                             ...
                             $motherData = $this->db->get_where('mother_registration',array('MotherID'=>$val['MotherID']))->row_array(); 
                               ...
                               // print_r($GetDangerSign);exit;
                                $babyIconStatus      = $this->load->BabyModel->getBabyIcon($GetDangerSign);
                            ?>
                            <li style="min-height: 195px !important;">
                                <span>
                                  <?php echo ($babyIconStatus == '1') ? "<img src='".base_url()."assets/images/happy-face.png' class='iconSet'>" : "<img src='".base_url()."assets/images/sad-face.png' class='iconSet'>"; ?>
                                </span>
                              <?php  if($val['BabyPhoto']==NULL){ ?>
                               <img src="<?php echo base_url();?>assets/images/user.png" alt="User Image" class="img-responsive" style="height:100px;width:100px;margin-top: -28px;">   
                                <?php } else {?>
                                <img src="<?php echo base_url();?>assets/images/baby_images/<?php echo $val['BabyPhoto']; ?>" alt="User Image" class="img-responsive" style="height:100px;width:100px;margin-top: -28px;">
                                <?php } ?>
          ...
          <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    ...
                    // mother danger sign
                      $motherIconStatus     = $this->load->MotherModel->getMotherIcon($get_last_assessment);
                      ?>
                      <li style="min-height: 195px !important;">
                        <span>
                        <?php
                        ...
                        <?php  if($value['MotherPicture']==NULL){ ?>
                         <img src="<?php echo base_url();?>assets/images/user.png" alt="User Image" class="img-responsive" style="height:100px;width:100px;margin-top: -28px;">   
                          <?php } else {?>
                          <img src="<?php echo base_url();?>assets/images/mother_images/<?php echo $value['MotherPicture']; ?>" alt="User Image" class="img-responsive" style="height:100px;width:100px;margin-top: -28px;">
                          <?php } ?>
