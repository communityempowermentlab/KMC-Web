...
<div class="login-box">
  ...
  <div class="login-logo">
    ...
    <p class="login-box-msg">Please enter your mobile number in order to Login</p>
    <?php echo $this->session->flashdata('login_message'); ?>


   <form method="post" action="<?php echo site_url().'facility/CheckMobile'; ?>">



      <div class="form-group has-feedback">
        <input type="hidden" name="loginType" class="form-control" value="1">
      </div>
     
      <div class="form-group has-feedback">
       
        <input oninput="maxLengthCheck(this)" type = "number" maxlength = "12"  min = "0" max = "999999999999" name="mobile" class="form-control" placeholder="Mobile Number" required >
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Get OTP</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
