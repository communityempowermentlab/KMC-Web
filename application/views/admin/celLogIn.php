...
<div class="login-box">
  ...
  <div class="login-logo"><center><?php  echo  'Employee Panel' ;?></center> </div>
    <p class="login-box-msg">Sign in to start your session</p>
  <?php echo $this->session->flashdata('login_message'); ?>

   <form method="post" action="<?php echo site_url().'Welcome/doCELLogin'; ?>">
      ...
      <div class="form-group has-feedback">
        ...
        <div class="checkbox icheck">
            <label><a href="<?php echo base_url();?>Admin/forgotPassword">Forgot Password?</a></label>
          </div>
