                     ...
                     $checkMonitoringOrNot = $this->db->get_where('babyDailyMonitoring',array('babyAdmissionId'=>$babyAdmissionData['id']))->num_rows();
                      ...
                      <?php } ?>
                        ...
                        <div class="form-group col-sm-12">
                          ...
                          <div class="col-sm-4 col-xs-4">
                            <label for="inputEmail3" class="control-label">Time of First Feed?</label>
                        ...
                        <div class="col-sm-12" style="overflow: auto;">    
                          <table cellpadding="0" cellspacing="0" border="0" class="table-striped table table-bordered editable-datatable  " id="example">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td><b>Is&nbsp;Temperature&nbsp;Available</b></td>
                                    <?php foreach($getBaby as $key => $value) { ?>
                                  ...
                                  <tr>
                                    <td><b>Is&nbsp;Taking&nbsp;Breast&nbsp;Feeds</b></td>
                                    <?php foreach($getBaby as $key => $value) { ?>
                        ...
                        <div class="col-md-12" style="overflow: auto;">
                          <table  cellpadding="0" cellspacing="0" border="0" class="table-striped table table-bordered editable-datatable example " id="example">
                            ...
                            <tbody>
                              ...
                              $getBaby = $this->db->get_where('prescriptionNurseWise',array('status'=>1,'babyId'=>$babyData['babyId']))->result_array();
                              $counter=1;
                              foreach($getBaby as $key => $value) { 
                                $nurseName = $this->BabyModel->singlerowparameter2('name','staffId',$value['nurseId'],'staffMaster');
                              ?>
...
<!-- Discharge Data -->
 ...
 <!-- Doctor Round Data -->
            ...
            <?php 
              ...
              $getTreatmentRecord     = $this->db->get_where('doctorBabyPrescription',array('babyId'=>$babyData['babyId']))->result_array();
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" class="table-striped table table-bordered editable-datatable example" id="example">
                    ...
                    <tbody>
                      ...
                      foreach($getTreatmentRecord as $key => $value) { 
                        ...
                        $motherName = $this->db->query("select mr.motherName from motherRegistration as mr inner join babyRegistration as br on br.motherId=mr.motherId where br.babyId=".$value['babyId']."")->row_array();
                      ?>
                        <tr>
                          <td><?php echo $counter++;?></td>
