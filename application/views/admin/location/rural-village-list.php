            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-12 pull-left">
                      <h5 class="content-header-title float-left pr-1 mb-0">Revenue Rural Village</h5>
                      <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0 breadcrumb-white" style="max-width: max-content; float: left;">
                          ...
                          <li class="breadcrumb-item active">Revenue Rural Village
                          </li>
                        </ol>
...
<div class="add-new">
  <a href="<?php echo base_url('Location/AddLocation/Rural');?>" class="btn btn btn-danger align-items-center">
