  ...
  <?php $adminData = $this->session->userdata('adminData');  ?>
    ...
    <section class="content">
     <?php 
        $GetMother = $this->load->UserModel->Mother();
        $fields   = array();
     foreach ($GetMother as $value) {
        $array[] = date("Y, n, j",$value['AddDate']);
       }
       $countingArray = array_count_values($array);
           $result = array_unique($array);
           $currentDat = time();
           $currentDate= date("Y, n, j",$currentDat);
          ...
          <div class="box box-solid">
            ...
            <div class="box-body">
              ...
              <div id="external-events">
                <div class="external-event bg-yellow">Admitted</div>
                <div class="external-event bg-green">Discharge</div>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
...
<script>
  $(function () {
    ...
    $('#calendar').fullCalendar({
      ...
      events: [
        {
          title: 'Mother <?php echo $countingArray[$currentDate]; ?>',
          start:'<?php echo $calendarDate; ?>',
