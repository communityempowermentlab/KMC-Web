           ...
           <div class="box-body">
              <div class="form-group" >
                     ...
                     <div class="col-sm-4" style="margin-top: 6px;">
                        ...
                        <?php
                        $TotalScore    = $this->db->query("SELECT SUM(score) as Allpoints from trainingapp_store_answer where userid=".$StaffIDs."")->row_array();
                ...
                <div class="row">
                  <?php $getSession =$this->db->query("SELECT * FROM trainingapp_manage_session where userType='1' ORDER BY id asc LIMIT 0,100")->result_array();
                    ...
                    <?php if(!empty($value['thumbnail'])){ ?>
                        <img src="http://52.201.54.81/trainingapp/uploads/session/<?php echo $value['thumbnail']; ?>" style="height:140px;width:140px;border:1px solid #ccc" class="img-circle">
                  <?php } else{ ?>
                        <img  src="http://52.201.54.81/trainingapp/uploads/session/d4ddc7c2c4876dafcb2173a19d89e353.gif" style="height:140px;width:140px;border:1px solid #ccc;" class="img-circle">
                <?php } ?>
