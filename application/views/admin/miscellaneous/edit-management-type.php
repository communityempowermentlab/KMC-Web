    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="col-12">
            <h5 class="content-header-title float-left pr-1 mb-0">Edit Management Type</h5>
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb p-0 mb-0 breadcrumb-white">
                ...
                <li class="breadcrumb-item active">Edit Management Type
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="row col-12">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <input type="text" class="form-control" name="managemnet_type_name" id="managemnet_type_name" placeholder="Management Type Name" required="" data-validation-required-message="This field is required" value="<?php echo $GetData['name']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
