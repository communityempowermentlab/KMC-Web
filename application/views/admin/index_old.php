      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo $this->UserModel->TotalGetCategorie()?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo $this->UserModel->TotalGetBrand()?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo $this->UserModel->TotalGetBanners() ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $this->UserModel->TotalGetUsers() ?></h3>
        ...
        <!-- ./col -->
         <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php echo $this->UserModel->TotalGetVendors() ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo $this->UserModel->TotalGetProducts() ?></h3>
     ...
     <section class="content">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo $this->UserModel->TotalGetVendorProduct($adminData['Id'])?></h3>
