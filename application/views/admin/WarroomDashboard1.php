...
<?php if($adminData['Type'] == 1){?>       
      <div class="row">
           ...
           $TotalBaby = count($this->db->query("SELECT * from baby_admission where status='1' and LoungeID=".$value['LoungeID']."")->result_array());
           ...
           $getStable = $this->db->query("SELECT * from baby_admission as ba inner join baby_monitoring as bm on bm.`BabyID`=ba.`BabyID` where ba.`LoungeID`=".$value['LoungeID']." and ba.`status`='1' order by bm.id desc")->result_array();         
                $stablecount   = 1 ;
                $unstablecount = 1;
                $stable=0;
                $unstable=0;
                ...
                $get_last_assessment = $this->db->query("SELECT * from baby_monitoring where LoungeID=".$value['LoungeID']." and BabyID=".$value1['BabyID']." order by id desc limit 0,1")->row_array();
                if($get_last_assessment['BabyRespiratoryRate'] > 60 || $get_last_assessment['BabyRespiratoryRate'] < 30){
                  $status1 = '1';
                                  
                 }

                if($get_last_assessment['BabyTemperature'] < 95.9 || $get_last_assessment['BabyTemperature'] > 99.5){
                  $status2 = '1';

                 }
                if($get_last_assessment['BabyPulseSpO2'] < 95 && $get_last_assessment['IsPulseOximatoryDeviceAvailable']=="Yes"){
                  $status3 = '1';
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="info-box" style="margin-bottom: 0px;">
                   ...
                   <?php } else { echo 'N/A'; } ?><br>
                     <span style="color:black;font-weight:600;">Mobile Number </span>: <?php echo ($getLastDutyNurseName['StaffMoblieNo'] != '') ? $getLastDutyNurseName['StaffMoblieNo'] : 'N/A'; ?><br>
                     <span style="color:black;font-weight:600;">Duty Date time &nbsp;</span>: <?php echo ($getLastDutyData['AddDate'] != '') ? date("d-m-Y g:i A",$getLastDutyData['AddDate']) : 'N/A'; ?><br>
                  </div>
                 </div>
                 <div class="info-box incode">
                   <div style="margin-left:10px;margin-top: 6px"> 
                    ...
                    <div class="row goodLook">
                          ...
                          <div class="col-lg-6 col-md-6">
                           <div class="countingsize text-center"><?php echo ($getMoicData['Name'] != "") ? $getMoicData['Name'] : 'N/A';?></div>
                          </div>
                    </div>
                    ...
                    <div class="row goodLook">
                          ...
                          <div class="col-lg-6 col-md-6">
                           <div class="countingsize text-center"><?php echo ($getMoicData['StaffMoblieNo'] != "") ? $getMoicData['StaffMoblieNo'] : 'N/A'; ?></div>
                          </div>
                    </div>
