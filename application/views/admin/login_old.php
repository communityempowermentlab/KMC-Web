...
<div class="login-box">
  ...
  <div class="login-logo">
   <img src="<?php echo site_url().'assets/Unt.png' ?>" style="max-width:120px;"> <br/><?php echo ($this->uri->segment('1')=='admin')?'Admin Panel':'School Panel' ?>
  </div>
      ...
      <?php } 
        if($TypeOfLogin=='school') { ?>
            <form method="post" action="<?php echo site_url().'admin/welcome/doLogin'; ?>">
              ...
              <div class="form-group has-feedback">
                <input type="hidden" name="loginType" class="form-control" value="3">
                <input type="email" name="email" class="form-control" placeholder="Email" required >
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
              </div>
              <div class="form-group has-feedback">
              ...
              <div class="row">
                <div class="col-xs-8">
                  <div class="checkbox icheck">
                    <label>
                      <a href="javascript:AddDeal()" data-toggle="myModal" data-target="#modal-default" style="margin-right : 5px "> Forget Password </a>
                    </label>
                  </div>
                </div>
                <!-- /.col -->
...
function ForgetPassword(){
  ...
  var check =    emailReg.test(email);
   if(check==true){
      ...
      $.ajax({ 
          type: "POST", 
          url: "<?php echo site_url('admin/School/ForgetPassword');?>", 
          data: "email="+email, 
