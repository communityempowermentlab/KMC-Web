      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" name='Lounge'  action="<?php echo site_url('supplimentM/AddSuppliment');?>" method="POST" enctype="multipart/form-data" onsubmit="return checkValidation()">
              <div class="box-body">
                ...
                <div class="col-sm-12 col-xs-12 form-group">
                  <div class="col-sm-4 col-xs-4">
                    <label for="inputPassword3" class="control-label">Suppliment Name
                     ...
                     <input type="text" class="form-control" name="suppliment_name" id="suppliment_name" placeholder="Suppliment Name" onblur="checkSuppliment(this.value)">
                  ...
                  <div class="col-sm-4 col-xs-4">
                    <label for="inputPassword3" class="control-label">Number Of Days
                     <span style="color:red">  *</span></label>
                     <input type="number" class="form-control" name="number_days" id="number_days" placeholder="Number Of Days">
