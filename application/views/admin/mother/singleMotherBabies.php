            ...
            <div class="box-body">
              <table cellpadding="0" cellspacing="0" border="0"
                ...
                foreach ($GetBaby as $value) {
                  ...
                  $getMotherRecord = $this->BabyModel->getMotherDataById('mother_registration',$value['BabyID']);
                ...
                <tr>
                  ...
                  <td><?php if($status=='0') {?>
                     ...
                     <?php } if($getMotherRecord['Type'] == '1'|| $getMotherRecord['Type'] == '3') { ?>
                    <a href="<?php echo base_url();?>motherM/viewMother/<?php echo $value['MotherID'];?>"><?php echo singlerowparameter2('MotherName','MotherID',$value['MotherID'],'mother_registration') ?></a>
                  <?php } else { ?> 

                     <a href="<?php echo base_url();?>motherM/viewMother/<?php echo $value['MotherID'];?>">UNKNOWN</a>
                  <?php } ?>
                  </td>
