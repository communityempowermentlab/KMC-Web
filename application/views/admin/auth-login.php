                    ...
                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <hr>
                                <div class="text-center" style="margin-top:-16px;font-size:14px;"><small class="mr-25">Login as Lounge</small><a href="<?php echo base_url() ?>Admin/loungeLogin"><small>Click Here</small></a></div>
                            </div>
                        </div>
                    </div>
                </div>
