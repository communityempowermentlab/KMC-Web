            ...
            <div class="card">
                <div class="card-header pb-1">
                    <div class="col-6 pull-left">
                      <h5 class="content-header-title float-left pr-1 mb-0">Discharge Mothers</h5>
                      <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0 breadcrumb-white">
                          <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fa fa-home" aria-hidden="true"></i></a>
                          </li>
                          <li class="breadcrumb-item active">Discharge Mother feedback form
                          </li>
                        </ol>
                      </div>
                    </div>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="row">
                                    ...
                                    <div class="col-md-2 p-0">
                                      <select class="select2 form-control" name="district" onchange="getFacility(this.value, '<?php echo base_url('FeedbackManagement/getFacility') ?>')">
                                    ...
                                    <div class="col-md-2 p-0">
                                      <select class="select2 form-control" name="facilityname" id="facilityname" onchange="getLounge(this.value, '<?php echo base_url('FeedbackManagement/getLounge') ?>'), getNurse(this.value, '<?php echo base_url('FeedbackManagement/getNurse') ?>')">
                                ...
                                <div class="col-md-2 p-0" id="dischargeTypeFilterBox" style="display: <?php echo ($motherStatus == "dischargedMother")?"block":"none"; ?>">
                                  <div class="col-md-11 p-0">
                                    <select class="select2 form-control" name="dischargeTypeFilterValue" id="dischargeTypeFilterValue">
                                      ...
                                      <option value="Died" <?php echo ($dischargeTypeFilterValue == 'Died') ? 'selected' : ''; ?>>Death</option>
                                    </select>
                                  </div>
                                </div>
                                <div class="col-md-4 p-0">
                                ...
                                <?php 
                                  ...
                                  foreach ($results as $val) { 
                                    ...
                                    // Last monitoring date
                                      ...
                                      $dischargeAt          = $this->FacilityModel->time_ago_in_php($getAdmissionData['dateOfDischarge']);
                                      $url = $motherPicture;

                                      $lastFeedbackData          = $this->FeedbackManagementModel->getMotherLastFeedback($val['motherId']);
                                      $feedbackStatusArray = array('call_connected'=>'Call Connected','call_not_connected'=>'Call Not Connected','refusal'=>'Refusal');
                                    ?>
                                    <tr>
                                      ...
                                      <td><?php echo empty($getAdmissionData['typeOfDischarge']) ? '-' : $getAdmissionData['typeOfDischarge']; ?></td>
                                      <!-- <td><?php echo empty($val['notAdmittedReason']) ? 'N/A' : $val['notAdmittedReason']; ?></td> -->
                                      <td><a href="<?php echo base_url() ?>FeedbackManagement/viewMotherFeedback/<?= $val['motherId'] ?>" class="btn btn-sm btn-info">Feedback</a></td>
                                      <td><?php if(!empty($lastFeedbackData['callStatus'])) { ?><a class="tooltip" href="<?php echo base_url(); ?>FeedbackManagement/viewFeedbackLog/<?php echo $lastFeedbackData['id']; ?>"><?php echo $feedbackStatusArray[$lastFeedbackData['callStatus']]; ?><span class="tooltiptext"><?php echo date("m/d/y, h:i A",strtotime($lastFeedbackData['modifyDate'])) ?></span></a><?php } else { echo "N/A"; } ?> </td>

                                      <td><a class="tooltip nonclick_link"><?php echo $dischargeAt; ?><span class="tooltiptext"><?php echo date("m/d/y, h:i A",strtotime($getAdmissionData['dateOfDischarge'])) ?></span></a></td>
