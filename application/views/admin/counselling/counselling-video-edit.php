...
if(($sessionData['Type']==2) && (in_array(74, $userPermittedMenuData) && !in_array(75, $userPermittedMenuData))){
  $pageHeading = "View";
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="col-12">
            <h5 class="content-header-title float-left pr-1 mb-0"><?php echo $pageHeading; ?> Counselling Video</h5>
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb p-0 mb-0 breadcrumb-white">
                ...
                <li class="breadcrumb-item active"><?php echo $pageHeading; ?> Counselling Video
                </li>
              </ol>
            </div>
          </div>
