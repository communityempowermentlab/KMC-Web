 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><?php echo 'Add CEL Employee';  ?></h1>
    </section>
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">  
            <form class="form-horizontal" name='Lounge'  action="<?php echo site_url('employeeM/addEmployee/');?>" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
              <div class="box-body">
                ...
                <div class="col-sm-12 col-xs-12 form-group">
                  ...
                  <div class="col-sm-4 col-xs-4">
                    ...
                    <input type="text" class="form-control" name="employee_name" placeholder="Name" id='employee_name'>
                  ...
                  <div class="col-sm-4 col-xs-4">
                    ...
                    <input type="text" class="form-control m_b_n" placeholder="Mobile Number" name="employee_mobile_number"  minlength="10" maxlength="10" id='employee_mobile_number' onchange="checkmobile(this)">
                  ...
                  <div class="col-sm-4 col-xs-4">
                    ...
                    <input type="text" class="form-control" placeholder="Email Id" name="employee_email" id="employee_email" onblur="checkEmail(this)">
                ...
                <div class="col-sm-12 col-xs-12 form-group">
                  ...
                  <div class="col-sm-4 col-xs-4">
                    ...
                    <input type="text" class="form-control" placeholder="Employee Code" name="employee_code" id="employee_code" onblur="checkEmployeeCode(this)">
 ...
 <style type="text/css">
    ...
    if(employee_mobile_number != ''){
      if(employee_mobile_number.length > 10 || employee_mobile_number.length < 10) {
        ...
        return false;
         ...
         $("#err_employee_mobile_number").load('<?php echo base_url('employeeM/checkLogInMobile');?>', {"mobile_number": employee_mobile_number, "column_name": "contactNumber", "table_name": "employeesData", "id": "", "id_column": "id"});
      }
    }
  }
  ...
  function checkEmployeeCode(data){
    ...
    if(employee_code != ''){
      $("#err_employee_code").load('<?php echo base_url('employeeM/checkEmpCode');?>', {"employee_code": employee_code, "column_name": "employeeCode", "table_name": "employeesData", "id": "", "id_column": "id"});
    }
  }
  ...
  function checkEmail(data){
    ...
    if(employee_email != ''){
      ...
      if(!email2) {
        ...
        $("#err_employee_email").load('<?php echo base_url('employeeM/checkLogInEmail');?>', {"email": employee_email, "column_name": "email", "table_name": "employeesData", "id": "", "id_column": "id"});
      } 
    }
  }
