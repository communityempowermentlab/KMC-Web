...
<html>
  <head>
    ...
    <title>Facility Registration Page</title>
    ...
    <div class="register-box">
      ...
      <div class="register-box-body col-md-12 col-xs-12">
        ...
        <div class="col-sm-12 col-xs-12 divPadding">
            ...
            <p id="err_msg"></p>
              <div class="form-group classic-tabs">
                ...
                <ul class="nav tabs-cyan" id="myClassicTab" role="tablist">
                  ...
                  <li class="nav-item <?php if ($tab_id == '') { echo "active"; } ?>">
                    <a class="nav-link waves-light <?php if ($tab_id == '') { echo "active"; } ?>" id="follow-tab-classic" data-toggle="tab" href="#menu1" role="tab"
                      aria-controls="follow-classic" aria-selected="false">Lounge Form</a>
                  </li>
          ...
          <div id="menu1" class="col-sm-12 col-xs-12 divPadding tab-pane fade <?php if ($tab_id == '') { echo "in active"; } ?>">
              ...
              <div class="input-field col-sm-12 col-xs-12">
                ...
                <div class="col-sm-12 col-xs-12 divPadding">
                  ...
                  <h5 id="last_updated" style="float: right;display: none;font-size: 16px;font-weight: 600;"></h5>
                    ...
                    <h4>Reclining Beds (Semi fowler beds with mattress)</h4>
                    ...
                    <h4>Chair & Table for Nurse (Nursing Station)</h4>
                    ...
                    <h4>High Stool for Weighing Scale</h4>
                    ...
                    <h4>Room Thermometer With Digital Clocks</h4>
                    ...
                    <h4>Availability Of Masks, Shoe Covers & Slippers</h4>
                    ...
                    <h4>Availability Of Baby Blanket/Wrap, Gown & KMC Baby Kit</h4>
                    ...
                    <h4>Availability Of Adult Blankets</h4>
                    ...
                    <h4>Digital Thermometer For Baby & Mother</h4>
                  ...
                  <div class="form-group">
                      <div class="col-sm-12 col-xs-12 divPadding">
                        <div class="input-field col-sm-12 col-xs-12">
                          <div class="form-group">
                            <center>
                              <button type="button" class="btn btn-submit btn-block btn-flat" id="submit_tab_2" data-toggle="modal" data-target="#modalPush">Save</button>
          ...
          <!--  +++++ Third Tab Information +++++++++ -->
            <div id="menu2" class="col-sm-12 col-xs-12 divPadding tab-pane fade <?php if ($tab_id == '2') { echo "in active"; } ?>">
              
              <?php echo form_open_multipart('RegistrationManagement/saveStaff'); ?>
                ...
                <div class="input-field col-sm-12 col-xs-12">
                  ...
                  <div class="col-sm-12 col-xs-12 divPadding">
                    ...
                    <div class="form-group ">
                      <div class="col-sm-12 col-xs-12 divPadding mg20">
                        ...
                        <div class="input-field col-sm-6 col-xs-12">
                          <div class="floating-label">
                            <select class="floating-select" onclick="this.setAttribute('value', this.value);" value="" id="staff_sub_type" name="staff_sub_type">
                              <option value=""></option>
                            </select>
                            <span class="highlight"></span>
                  ...
                  <div class="input-field col-sm-12 col-xs-12 radioCSS">
                      <input type="checkbox" value="1" id="staff_terms" class="form-checkbox" data-toggle="modal" data-target="#modalPushStaff" onchange="applyReadonly('staff_terms')"><label for="radio-two">By signing this form I agree that all of the above statements are true and accurate.</label>
                  ...
                  <div class="input-field col-sm-12 col-xs-12">
                    <div class="form-group">
                        <div class="col-sm-12 col-xs-12 divPadding">
                          <div class="input-field col-sm-12 col-xs-12">
                            <div class="form-group">
                              <center><button type="submit" class="btn btn-submit btn-block btn-flat" id="submit_tab_3">Save</button></center>
                            </div>
                          </div>
                        </div>
  ...
  function getLastUpdate(lounge_id){
    ...
    $.ajax({
        ...
        success: function(result) { console.log(result)
          if(result.result2 != ''){
            if(result.result1 != 0){
              $("#last_updated").css('color', 'red').html(result.result2).show();
            } else {
              $("#last_updated").css('color', 'green').html(result.result2).show();
            }
          } else {
...
//return false;
  ...
  function sendOTPStaff(){
    ...
    if(mobile.length == 10) { 
      $('#err_mobile_verify_staff').html('').hide();
