    ...
    <div class="register-box">
      ...
      <div class="register-box-body col-md-12 col-xs-12">
        ...
        <div class="col-sm-12 col-xs-12 divPadding">
              ...
              <div class="form-group classic-tabs">
                ...
                <ul class="nav tabs-cyan" id="myClassicTab" role="tablist">
                  ...
                  <li class="nav-item active">
                    <a class="nav-link waves-light active" id="contact-tab-classic" data-toggle="tab" href="#menu2" role="tab"
                      aria-controls="contact-classic" aria-selected="false">Staff Registration form</a>
                  </li>
          ...
          <div id="menu1" class="col-sm-12 col-xs-12 divPadding tab-pane fade">
          ...
          <!--  +++++ Third Tab Information +++++++++ -->
            <div id="menu2" class="col-sm-12 col-xs-12 divPadding tab-pane fade in active">
