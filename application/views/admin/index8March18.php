...
<head>
  ...
  <title>Kangroo Care| Log in</title>
...
.login-page2{
  background-image: url(<?php  echo base_url('/assets/tst.png');?>) !important;
...
<div class="login-box">
  ...
  <div class="login-logo">
   <img src="<?php echo site_url().'assets/logo_white.png' ?>" style="max-width:120px;"> <br/> <?php  echo  'Admin Panel' ;?>
  </div>
