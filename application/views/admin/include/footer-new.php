<!-- BEGIN: Footer-->
    <footer class="footer footer-static footer-light">
      <p class="clearfix mb-0"><span class="float-left d-inline-block">Copyright © <?php echo date('Y'); ?> - All rights reserved CEL</span>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url(); ?>app-assets/js/scripts/pages/dashboard-analytics.min.js"></script>
    <!-- END: Page JS-->
    ...
    <script src="<?php echo base_url(); ?>app-assets/js/scripts/forms/number-input.min.js"></script>

    <script src="<?php echo base_url(); ?>app-assets/js/scripts/extensions/sweet-alerts.min.js"></script>

    <script src="<?php echo base_url(); ?>app-assets/js/scripts/pickers/dateTime/pick-a-datetime.min.js"></script>

    

    <script type="text/javascript" src="<?php echo base_url(); ?>twd-theme/videojs/video.js"></script>
