...
class BabyDischarge extends CI_Controller {
    ...
    public function index() {
        ...
        //print_r($requestJson[APP_NAME]);exit;
        ...
        $data['lengthMeasureNotAvlReasonDischarge'] = trim($requestJson[APP_NAME]['lengthMeasureNotAvlReasonDischarge']);
        $data['lengthMeasureNotAvlReasonOtherDischarge'] = trim($requestJson[APP_NAME]['lengthMeasureNotAvlReasonOtherDischarge']);
        $data['headMeasureNotAvlReasonDischarge'] = trim($requestJson[APP_NAME]['headMeasureNotAvlReasonDischarge']);
        $data['headMeasureNotAvlReasonOtherDischarge'] = trim($requestJson[APP_NAME]['headMeasureNotAvlReasonOtherDischarge']);
