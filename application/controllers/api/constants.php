...
define('sehmatiPatra', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/sehmatiPatra/');
define('imageDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/');
define('signDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/sign/');
define('loungeDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/lounge/');
define('motherDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/motherImages/');
define('padDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/motherImages/pad/');
define('pdfDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/pdfFile/');
define('babyDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/babyImages/');
define('babyWeightDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/babyImages/weight/');
define('babyTemperaturetDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/babyImages/temperature');
define('commentDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/babyImages/comment/');
define('reportDirectory', $_SERVER['DOCUMENT_ROOT'].'/mncuTesting/assets/images/investigationImages/');

define('babyDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/images/babyImages/');
define('motherDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/images/motherImages/');
define('videoDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/video/');
define('pdfDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/pdfFile/');
define('imageDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/images/');
define('signDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/images/sign/');
define('babyWeightDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/images/babyImages/weight/');
define('babyTemperaturetDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/images/babyImages/temperature/');
define('commentDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/images/babyImages/comment/');
define('loungeDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/images/lounge/');
define('investigationDirectoryUrl', 'http://'.$_SERVER['HTTP_HOST'].'/mncuTesting/assets/images/investigationImages/');

//directory for storing images related babywisedoctorround api images


define('APP_NAME', 'mncu');
...
define('PROJECT_NAME', 'MNCU');
define('PROJECTNAME', 'The Kangaroo Care Project');
define('PACKAGE', 'com.mncu.android');
